...
public:
        ...
        : storedChans(new proto::StorageBip47ChannelList)
    {
        ...
        storedChans->set_localpaymentcode(
            "PM8TJKEj41Q66s6Vqe3JDCAzpo4NSgihP5R4vwRHGE4f26HFQi7guJEvVyFAc9hghN"
            "fLHknBcK986Q123cnU266ZD19APzpkgUP8ed7qEh7g2WCpNaAg");
        ...
        storedChans->set_remotepaymentcode(
            "PM8TJS2JxQ5ztXUpBBRnpTbcUXbUHy2T1abfrb3KkAAtMEGNbey4oumH7Hc578WgQJ"
            "hPjBxteQ5GHHToTYHE3A1w6p7tU6KSoFmWBVbFGjKPisZDbP97");
    }
};
...
TEST_F(Test_StorageBip47ChannelList, paymentcodes)
{
    ...
    ASSERT_FALSE(proto::Validate(*storedChans, false));
    storedChans->set_localpaymentcode(
        "PM8TJMs2mSP5UVDU4TFJiWtiLCEqYfhvKDnEov5tH8pSU2Sky2hdgNALShkGN3LcRNsivq"
        "BiNnAHo44rpRudvVc3oWQTmqYyavRjNKH38s5sX15n7C1F");
    ASSERT_TRUE(proto::Validate(*storedChans, false));
