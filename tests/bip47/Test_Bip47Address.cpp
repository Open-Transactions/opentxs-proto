...
namespace {
  ...
  public:
    ...
    Test_Bip47Address() : addr(new proto::Bip47Address) {
      addr->set_version(1);
...
TEST_F(Test_Bip47Address, validTxHashes)
{
  ...
  // test: add tx hashes
  addr->add_incoming("ff722643c6195c487324739f3662a74788317e292167bd7ed50103be844c9a05");
  addr->add_incoming("b9c0876666c9941d1497f8dfa885c3c4140b53949724bbe5755b66018d4e7212");
  addr->add_incoming("6f0f60d00a83a1c3f167f1b4af81ac337f04558790f6c841e804c9025bdac167");
  ASSERT_TRUE(proto::Validate(*addr, false));
