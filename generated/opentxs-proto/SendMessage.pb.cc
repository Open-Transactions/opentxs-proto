...
void InitDefaultsSendMessageImpl() {
  ...
  ::opentxs::proto::SendMessage::InitAsDefaultInstance();
}

void InitDefaultsSendMessage() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSendMessageImpl);
}
...
const int SendMessage::kVersionFieldNumber;
const int SendMessage::kSenderFieldNumber;
const int SendMessage::kContactFieldNumber;
...
SendMessage::SendMessage()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:opentxs.proto.SendMessage)
}
...
SendMessage* SendMessage::New(::google::protobuf::Arena* arena) const {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:opentxs.proto.SendMessage)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:opentxs.proto.SendMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:opentxs.proto.SendMessage)
  return false;
#undef DO_
}
...
void SendMessage::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:opentxs.proto.SendMessage)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // repeated string contact = 3;
  for (int i = 0, n = this->contact_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteString(
      3, this->contact(i), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:opentxs.proto.SendMessage)
}
...
// @@protoc_insertion_point(message_byte_size_start:opentxs.proto.SendMessage)
  ...
  // repeated string contact = 3;
  total_size += 1 *
      ::google::protobuf::internal::FromIntSize(this->contact_size());
  for (int i = 0, n = this->contact_size(); i < n; i++) {
