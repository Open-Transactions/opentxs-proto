...
class StorageItems : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:opentxs.proto.StorageItems) */ {
 public:
  ...
  static const int kMasterSecretFieldNumber = 11;
 ...
 private:
  ...
  void set_has_master_secret();
  void clear_has_master_secret();
...
inline void StorageItems::set_has_master_secret() {
  _has_bits_[0] |= 0x00000200u;
}
inline void StorageItems::clear_has_master_secret() {
  _has_bits_[0] &= ~0x00000200u;
}
...
inline ::opentxs::proto::Ciphertext* StorageItems::mutable_master_secret() {
  set_has_master_secret();
  if (master_secret_ == NULL) {
    master_secret_ = new ::opentxs::proto::Ciphertext;
  }
...
inline void StorageItems::set_allocated_master_secret(::opentxs::proto::Ciphertext* master_secret) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(master_secret_);
  }
  if (master_secret) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      master_secret = ::google::protobuf::internal::GetOwnedMessage(
