...
enum RPCCommandType {
  ...
  RPCCOMMAND_LISTCLIENTSSESSIONS = 3,
  RPCCOMMAND_LISTSERVERSSESSIONS = 4,
...
const RPCCommandType RPCCommandType_MAX = RPCCOMMAND_GETCONTACTACTIVITY;
...
const RPCPushType RPCPushType_MAX = RPCPUSH_CONTACT;
