...
{
const std::size_t MIN_PLAUSIBLE_IDENTIFIER{20};
const std::size_t MAX_PLAUSIBLE_IDENTIFIER{116};
const std::size_t MIN_PLAUSIBLE_KEYSIZE{16};
const std::size_t MAX_PLAUSIBLE_KEYSIZE{8192};
const std::size_t MIN_PLAUSIBLE_SIGNATURE{32};
const std::uint32_t MAX_VALID_PORT{65535};
const std::size_t MAX_VALID_CONTACT_VALUE{512};
const std::size_t MAX_LABEL_SIZE{512};
...
const ContactItemMap AllowedItemTypes{
...
const ItemAttributeMap AllowedItemAttributes{
...
const std::set<ContactSectionName> AllowedSubtypes{CONTACTSECTION_PROCEDURE};

const EnumTranslation ContactSectionNames{
...
const EnumTranslation ContactItemTypes{
...
const EnumTranslation ContactItemAttributes{
    {{CITEMATTR_ACTIVE, "en"}, "Active"},
    {{CITEMATTR_PRIMARY, "en"}, "Primary"},
    {{CITEMATTR_LOCAL, "en"}, "Local"}};

const RelationshipReciprocity RelationshipMap{
